...
use zemacs_core::syntax::config::{DebugAdapterConfig, DebuggerQuirks};
use zemacs_dap_types::*;
...
impl Client {
    ...
    pub fn stdio(
        ...
        let cmd = zemacs_stdx::env::which(cmd)?;
    ...
    pub fn call<R: zemacs_dap_types::Request>(
        &self,
    ...
    pub async fn request<R: zemacs_dap_types::Request>(
        &self,
        params: R::Arguments,
    ) -> Result<R::Result>
    where
    ...
    pub async fn initialize(&mut self, adapter_id: String) -> Result<()> {
        let args = requests::InitializeArguments {
            ...
            client_name: Some("zemacs".to_owned()),
            adapter_id,
