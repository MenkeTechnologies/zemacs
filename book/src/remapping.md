...
directory (default `~/.config/zemacs` on Linux systems) with a structure like
this:
...
C-o = ":open ~/.config/zemacs/config.toml" # Maps Ctrl-o to opening of the zemacs config file
