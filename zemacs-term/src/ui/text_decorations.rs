...
use zemacs_core::doc_formatter::FormattedGrapheme;
use zemacs_core::Position;
use zemacs_view::editor::CursorCache;
...
/// [`LineAnnotation`](zemacs_core::text_annotations::LineAnnotation)s in [`zemacs_view::View::text_annotations`]
