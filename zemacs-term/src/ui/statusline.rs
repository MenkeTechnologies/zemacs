...
use zemacs_core::{coords_at_pos, encoding, unicode::width::UnicodeWidthStr, Position};
use zemacs_lsp::lsp::DiagnosticSeverity;
use zemacs_view::document::DEFAULT_LANGUAGE_NAME;
use zemacs_view::{
...
{
    match element_id {
        zemacs_view::editor::StatusLineElement::Mode => render_mode,
        zemacs_view::editor::StatusLineElement::Spinner => render_lsp_spinner,
        zemacs_view::editor::StatusLineElement::FileBaseName => render_file_base_name,
        zemacs_view::editor::StatusLineElement::FileName => render_file_name,
        zemacs_view::editor::StatusLineElement::FileAbsolutePath => render_file_absolute_path,
        zemacs_view::editor::StatusLineElement::FileModificationIndicator => {
            render_file_modification_indicator
        }
        zemacs_view::editor::StatusLineElement::ReadOnlyIndicator => render_read_only_indicator,
        zemacs_view::editor::StatusLineElement::FileEncoding => render_file_encoding,
        zemacs_view::editor::StatusLineElement::FileLineEnding => render_file_line_ending,
        ...
        zemacs_view::editor::StatusLineElement::Position => render_position,
        zemacs_view::editor::StatusLineElement::PositionPercentage => render_position_percentage,
        zemacs_view::editor::StatusLineElement::TotalLineNumbers => render_total_line_numbers,
        zemacs_view::editor::StatusLineElement::Separator => render_separator,
        zemacs_view::editor::StatusLineElement::Spacer => render_spacer,
        zemacs_view::editor::StatusLineElement::VersionControl => render_version_control,
