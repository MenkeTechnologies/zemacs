...
use zemacs_lsp::lsp;
use zemacs_lsp::lsp::{CompletionContext, CompletionTriggerKind};
use zemacs_lsp::util::pos_to_lsp_pos;
...
impl zemacs_event::AsyncHook for CompletionHandler {
