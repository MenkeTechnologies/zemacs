...
macro_rules! key {
    ($key:ident) => {
        ::zemacs_view::input::KeyEvent {
            code: ::zemacs_view::keyboard::KeyCode::$key,
            modifiers: ::zemacs_view::keyboard::KeyModifiers::NONE,
        }
    };
    ($($ch:tt)*) => {
        ::zemacs_view::input::KeyEvent {
            code: ::zemacs_view::keyboard::KeyCode::Char($($ch)*),
            modifiers: ::zemacs_view::keyboard::KeyModifiers::NONE,
        }
    };
}
...
macro_rules! shift {
    ($key:ident) => {
        ::zemacs_view::input::KeyEvent {
            code: ::zemacs_view::keyboard::KeyCode::$key,
            modifiers: ::zemacs_view::keyboard::KeyModifiers::SHIFT,
        }
    };
    ($($ch:tt)*) => {
        ::zemacs_view::input::KeyEvent {
...
macro_rules! ctrl {
    ($key:ident) => {
        ::zemacs_view::input::KeyEvent {
            code: ::zemacs_view::keyboard::KeyCode::$key,
            modifiers: ::zemacs_view::keyboard::KeyModifiers::CONTROL,
        }
    };
    ($($ch:tt)*) => {
        ::zemacs_view::input::KeyEvent {
...
macro_rules! alt {
    ($key:ident) => {
        ::zemacs_view::input::KeyEvent {
            code: ::zemacs_view::keyboard::KeyCode::$key,
            modifiers: ::zemacs_view::keyboard::KeyModifiers::ALT,
        }
    };
    ($($ch:tt)*) => {
        ::zemacs_view::input::KeyEvent {
...
macro_rules! keymap {
    ...
    (
        ...
        // modified from the hashmap! macro
        {
            ...
            $(
                $(
                    let _key = $key.parse::<::zemacs_view::input::KeyEvent>().unwrap();
