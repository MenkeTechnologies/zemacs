...
/// ```rust
/// # use zemacs_tui::widgets::Cell;
/// # use zemacs_tui::text::{Span, Spans, Text};
/// # use zemacs_view::graphics::{Style, Modifier};
...
/// ```rust
/// # use zemacs_tui::widgets::{Block, Borders, Table, Row, Cell};
/// # use zemacs_tui::layout::Constraint;
/// # use zemacs_view::graphics::{Style, Color, Modifier};
/// # use zemacs_tui::text::{Text, Spans, Span};
/// Table::new(vec![
