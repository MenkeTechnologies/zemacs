...
//!
//! ```rust
//! # use zemacs_tui::widgets::Block;
//! # use zemacs_tui::text::{Span, Spans};
//! # use zemacs_view::graphics::{Color, Style};
...
impl<'a> Span<'a> {
    ...
    ///
    /// ```rust
    /// # use zemacs_tui::text::{Span, StyledGrapheme};
    /// # use zemacs_view::graphics::{Color, Modifier, Style};
