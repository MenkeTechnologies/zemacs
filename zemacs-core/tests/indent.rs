...
fn test_treesitter_indent_rust_helix() {
    ...
    for file in files.split_whitespace() {
        ...
        let ignored_lines: Vec<Range<usize>> = match file {
            "zemacs-term/src/application.rs" => vec![
            ...
            "zemacs-term/src/commands.rs" => vec![
            ...
            "zemacs-term/src/commands/dap.rs" => vec![
                // Complex `format!` macro
                46..52,
            ],
            "zemacs-term/src/commands/lsp.rs" => vec![
                // Macro
                624..627,
                ...
                878..879,
                // Same as in `zemacs-term/src/commands.rs`
                1335..1343,
            ],
            "zemacs-term/src/config.rs" => vec![
                // Multiline string
                146..152,
            ],
            "zemacs-term/src/keymap.rs" => vec![
                // Complex macro (see above)
                456..470,
                // Multiline string without indent
                563..567,
            ],
            "zemacs-term/src/main.rs" => vec![
                // Multiline string
                44..70,
            ],
            "zemacs-term/src/ui/completion.rs" => vec![
                // Macro
                218..232,
            ],
            "zemacs-term/src/ui/editor.rs" => vec![
            ...
            "zemacs-term/src/ui/lsp.rs" => vec![
                // Macro
                56..61,
            ],
            "zemacs-term/src/ui/statusline.rs" => vec![
                // Same as in `zemacs-term/src/commands.rs`
                436..442,
                450..456,
            ],
...
fn test_treesitter_indent(
    ...
    std::env::set_var("ZEMACS_RUNTIME", runtime.to_str().unwrap());
