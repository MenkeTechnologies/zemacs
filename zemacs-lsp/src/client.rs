...
impl Client {
    ...
    /// (i.e. zemacs's *outbound* write completed — independent of how slow the server
    ...
    pub fn text_document_document_color(
        ...
        let params = lsp::DocumentColorParams {
            ...
            partial_result_params: zemacs_lsp_types::PartialResultParams {
